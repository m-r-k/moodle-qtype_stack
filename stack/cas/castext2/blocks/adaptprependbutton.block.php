 ...
 * This class adds in the "adapt button" blocks to castext.
 */
class stack_cas_castext2_adaptprependbutton extends stack_cas_castext2_block {
    ...
    public function compile($format, $options): ?MP_Node {
        ...
        $code .= "if (input.value=='true'){ prepend(); }\n";
    ...
    public function validate(&$errors=[], $options=[]): bool {
        ...
        if (!array_key_exists('prepend_ids', $this->params)) {
            $errors[] = new $options['errclass']('Adaptbutton block requires a prepend_ids parameter.',
                $options['context'] . '/' .
                $this->position['start'] . '-' . $this->position['end']);
            return false;
        }
