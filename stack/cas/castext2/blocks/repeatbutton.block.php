...
class stack_cas_castext2_repeatbutton extends stack_cas_castext2_block {
    ...
    public function compile($format, $options): ?MP_Node {
        ...
        $code .= "input.addEventListener('change', () => {
                console.log('input_changed:', input.value);});\n";
        $code .= "});\n";
		...
		if (isset($this->params['repeat_ids'])) {
			...
			foreach ($splitrepeatid as &$id) {
                ...
                $list[] = new MP_String("    console.log('repeat_content_before:', repeat_content);\n");
				...
				$list[] = new MP_String("    console.log('repeat_content_after:', repeat_content);\n");
